    ...
    return (
        <div className="container" style={{ padding: '4rem 1rem', maxWidth: '800px' }}>
            ...
            <div className="card" style={{ padding: '2rem' }}>
                ...
                <p style={{ marginBottom: '1rem', fontSize: '1.1rem', color: 'var(--text-muted)' }}>
                    Our mission is to bring people together through memorable experiences. Whether you are looking to attend a local workshop,
                     a concert, or a corporate networking event, EMS simplifies the process.
                </p>
                <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem' }}>For Organizers</h2>
                <p style={{ marginBottom: '1rem', fontSize: '1.1rem', color: 'var(--text-muted)' }}>
                    We provide powerful tools for organizers to create, manage, and track their events. From real-time analytics to seamless
